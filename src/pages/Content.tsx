            ...
            <section className="bg-slate-900 pt-16 sm:pt-24 pb-8 sm:pb-12">
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="flex flex-row text-white p-4">
                        ...
                        <a href="https://www.linkedin.com/in/uday-cheekatipalli-6002962b1/" target="_blank" className="transition ease-in-out duration-500 hover:-translate-2 hover:scale-110 px-4 hover:text-green-300" rel="noreferrer">
